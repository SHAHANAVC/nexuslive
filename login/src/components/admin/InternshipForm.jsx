...
//     city: student?.city || '',
//     pin: student?.pin || student?.pincode|| '',
...
//       'institution', 'college', 'dob', 'age', 'email', 'phone', 
//       'address', 'city', 'pin', 'district', 'state', 'qualification',
//       , 'course', 'modeOfCourse', 'dateOfJoining', 'fees'
//     ];
...
const InternshipForm = ({ student, onSave, onCancel }) => {
  ...
  const validateForm = () => {
    ...
    const requiredFields = [
      'institution', 'college', 'dob', 'age', 'email', 'phone', 
      'address', 'city', 'pin', 'district', 'state', 'qualification',
      'course', 'modeOfCourse', 'dateOfJoining', 'fees', 'name', 'preferredDuration'
    ];
