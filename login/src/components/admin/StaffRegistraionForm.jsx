...
//     const key = name.split('.')[1]; // name, phone, or relation
//     setStaffData(prev => ({
//       ...prev,
//       emergencyContact: {
...
//           value={staffData.emergencyRelation || ''}
//           onChange={handleChange}
...
//       <Col xs={12} md={4}>
//         <Form.Label className="text-light very-small mb-0">Name</Form.Label>
//         <Form.Control
//           size="sm"
//           type="text"
...
//       <Col xs={12} md={4}>
//         <Form.Label className="text-light very-small mb-0">Contact</Form.Label>
//         <Form.Control
//           size="sm"
//           type="tel"
...
//       <Col xs={12} md={4}>
//         <Form.Label className="text-light very-small mb-0">Relation</Form.Label>
//         <Form.Control
//           size="sm"
//           type="text"
...
const handleSubmit = async (e) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="xl" centered scrollable responsive>
          ...
          <Row className="g-2 g-md-3">
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Enter full name"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.name}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Enter email address"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.email}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Enter password"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.password}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Confirm password"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.confirmPassword}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control.Feedback type="invalid" className="small">{errors.phone}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Enter complete address"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.address}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control.Feedback type="invalid" className="small">{errors.qualification}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  className="bg-dark text-white border-secondary"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.dateOfJoining}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control.Feedback type="invalid" className="small">{errors.department}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            ...
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  placeholder="Enter designation (e.g., Manager, Clerk)"
                />
                <Form.Control.Feedback type="invalid" className="small">{errors.designation}</Form.Control.Feedback>
              </Form.Group>
            </Col>
                ...
                <div className="d-flex flex-wrap gap-2">
                  {['active', 'probation', 'resigned'].map((status) => (
                    <Form.Check
                      ...
                      label={
                        <span className="text-capitalize small">
                          <Badge bg={getStatusVariant(status)} className="me-1">{status}</Badge>
                        </span>
                      }
                      className="text-light"
                    />
      ...
      <Modal.Footer className="bg-dark border-secondary d-flex flex-column flex-sm-row gap-2">
        <Button variant="outline-light" onClick={resetForm} size="sm" className="d-flex align-items-center gap-2 order-2 order-sm-1">
          <i className="bi bi-arrow-clockwise"></i> Reset
        </Button>
        <div className="d-flex gap-2 order-1 order-sm-2">
          <Button variant="secondary" onClick={handleClose} size="sm">Cancel</Button>
          <Button variant="primary" onClick={handleSubmit} className="d-flex align-items-center gap-2" size="sm">
